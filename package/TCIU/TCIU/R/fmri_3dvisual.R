...
#'
#' @param pval a 3D array p value used to plot activated area of the brain
...
#' with its activated parts based on given p values. The p values are generated by
#' applying statistical test on fMRI data. When providing input of a 3D array p value data, 
...
fmri_3dvisual = 
  function(pval, mask, p_threshold=0.05, 
           method="scale_p", color_pal = "YlOrRd", multi_pranges=TRUE, title=NULL){
    ...
    p = plot_ly()%>%
      add_trace(boundry_pt_df, 
                ...
                type = "mesh3d", opacity = 0.08, name = "Brain Mask",
                # facecolor = color_sel,
