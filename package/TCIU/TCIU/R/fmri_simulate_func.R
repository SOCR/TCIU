...
#' @description an fMRI data simulation function, used to simply generate a 3 dimension area with activated parts inside. 
#'
#' @param dim_data a vector of length three to identify the dimension of fMRI data wanted to simulate
...
#' @param mask a parameter to have the fMRI data with the brain-shaped mask provided in the package, or the 3d sphere mask 
